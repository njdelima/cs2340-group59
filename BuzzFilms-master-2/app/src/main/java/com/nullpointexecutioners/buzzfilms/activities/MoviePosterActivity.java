...
public class MoviePosterActivity extends Activity {
    ...
    protected void onPostCreate(Bundle savedInstanceState) {
        ...
        // are available.
        final int DELAY_HIDE = 100; //in ms
        delayedHide(DELAY_HIDE);
    }

    /**
     * is to hide or show a feature
     */
    private void toggle() {
        if (mVisible) {
            hide();
    ...
    /**
     * to hide a part of the UI of movie poster
     */
    private void hide() {
        // Hide UI first
        final ActionBar actionBar = getActionBar();
    ...
    /**
     * show part of the ui of movie poster
     */
    @SuppressLint("InlinedApi")
    private void show() {
        // Show the system bar
