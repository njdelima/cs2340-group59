 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Neeraj DeLima");
		  toPrint += p1.toString("delima3");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Komal Hirani");
		  toPrint += p2.toString("khirani6");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Min Ho Lee");
		  toPrint += p3.toString("mlee432");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Emma Staniforth");
                  toPrint += p4.toString("estaniforth3");
                  //Person5 replace P4 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("Eduardo Mestanza");
                  toPrint += p5.toString("emestanza3");
